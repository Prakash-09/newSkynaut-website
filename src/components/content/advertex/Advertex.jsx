    ...
    render() {
        ...
        return (
            <div className="advertex-component">
                <Row className="m-0 content-section mt-5" xs="1" md="2">
                ...
                <Row className="m-0 content-section mt-5">
                    <Col className="p-0">
                        <h1 className="maintext text-center pt-4 mt-3">
                ...
                <Row className="m-0 content-section mt-5" xs="1" md="1">
                    ...
                    <Col className="p-0">
                        <Row className="m-0 text-right">
                            <Col className="p-0  text-right">
                                {data.ONE_SOLUTION_ADVERTEX.map((card, cardIdx) =>
                                    cardIdx === 5 &&
                                    <div key={cardIdx} className="one-solution-advertex-card text-right">
                                        <h5 className="card-title">{card.title}</h5>
                                        <small>{card.description}</small>
                                    </div>
                                )}
                            ...
                            <Col className="p-0 text-left">
                                {data.ONE_SOLUTION_ADVERTEX.map((card, cardIdx) =>
                                    cardIdx === 6 &&
                                    <div key={cardIdx} className="one-solution-advertex-card text-left">
                                        <h5 className="card-title">{card.title}</h5>
                                        <small>{card.description}</small>
                                    </div>
                                )}
                ...
                <Row className="m-0 content-section" xs="1" md="3">
                ...
                <Row className="content-section m-0 mb-5 mt-4" xs="4" md="4">
                    {tabs.map((tab, tabIdx) =>
                ...
                <Row className="content-section m-0 " xs="1" md="2">
                    <Col className="p-0">
                    ...
                    <Col className="p-0 pl-4 data-v-center">
                        <div>
                            ...
                            <p className="m-0 learn-more text-left">Learn More <i className="fa fa-long-arrow-right" /></p>
                        </div>
                    </Col>
                </Row>
                <Row className="m-0 content-section">
                ...
                <Row className="my-5 text-center content-section">
                    <Col className="p-0">
